...
foreach ($giderler as $gider) {
    ...
    $firma_adi = !empty($gider['odeme_yapilan_firma']) ? $gider['odeme_yapilan_firma'] : 'Diğer';
    ...
    if (array_key_exists($firma_adi, $firmalar)) {

        $firmalar[$firma_adi] += $tutar;
...
// Kategorileri ve firmaları alfabetik sıraya göre sırala
...
<body>
            ...
            <div class="col-md-6 mb-4">
                ...
                <div class="chart-card">
                    ...
                    <div class="chart-container">
                        ...
                        <div id="firmaGiderlerChart" style="width: 100%; height: 100%;"></div>
    ...
    <script>
        ...
        var firmalar = <?php echo json_encode($firmalar); ?>;
        ...
        var firmaGiderlerChart = echarts.init(document.getElementById('firmaGiderlerChart'));
        ...
        // Firmalara göre veri filtreleme fonksiyonu

        function getFirmaVerileri(seciliAy) {
            ...
            filtrelenmisGiderler.forEach(function(gider) {
                ...
                if (firmaVerileri[firma]) {

                    firmaVerileri[firma] += tutar;
            ...
            aylar.forEach(function(ay) {
                ...
                for (var kategori in tumAylarKategoriVerileri[ay]) {
                    ...
                    if (fark > 2) {
                        ...
                        tumAylarAnormalKategoriler[ay][kategori] = { ayOrani: ayOrani, genelOran: genelOran, fark: fark };
        ...
        function createPieChart(chartInstance, title, data) {
            ...
            var option = {
                ...
                series: [{
                    ...
                    data: Object.keys(data).map(name => ({ value: data[name], name: name }))
        ...
        // Başlangıçta grafikler

        createPieChart(kategoriGiderlerChart, 'Kategori Bazında Giderler', getKategoriVerileri(currentMonth));

        createPieChart(firmaGiderlerChart, 'Firmalara Göre Gider Dağılımı', getFirmaVerileri(currentMonth));
        ...
        $('#aySecici').on('change', function() {
            ...
            createPieChart(kategoriGiderlerChart, 'Kategori Bazında Giderler', getKategoriVerileri(selectedMonth));

            createPieChart(firmaGiderlerChart, 'Firmalara Göre Gider Dağılımı', getFirmaVerileri(selectedMonth));
