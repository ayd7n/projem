...
INSERT INTO `ayarlar` VALUES (1,'dolar_kuru','42.3360'),(2,'euro_kuru','49.0680'),(3,'son_otomatik_yedek_tarihi','2025-11-18 14:30:11'),(4,'maintenance_mode','off');
...
INSERT INTO `cerceve_sozlesmeler` VALUES (19,3,'Tedarikçi Abdi',37,'Ambalaj Malzemesi 2',10.00,'TL',100,10,'2025-01-31','2030-02-02','Admin User','2025-11-13 23:26:07','',1);
...
INSERT INTO `esans_is_emirleri` VALUES (3,'2025-10-22','Admin User','ES010','Bergamot Essence                                            ','TANK001','Esans Tankı 1                                            ',20.00,'ml','2025-10-22',30,'2025-11-21','2025-10-24','2025-10-24','   ','tamamlandi',10.00,0.00),(6,'2025-10-23','Admin User','ES010','Bergamot Essence Updated','TANK002','Esans Tankı 2',75.00,'ml','2025-10-24',35,'2025-11-28','2025-10-24','2025-10-24','Updated test work order  Updated test work order ','tamamlandi',60.00,0.00),(7,'2025-10-23','Admin User','ES010','Bergamot Essence','TANK001','Esans Tankı 1',50.00,'ml','2025-10-23',30,'2025-11-22','2025-10-24','2025-10-24','Test work order with components Production completed successfully Test work order with components Production completed successfully','tamamlandi',40.00,0.00);
/*!40000 ALTER TABLE `esans_is_emirleri` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `esans_is_emirleri_eksik_miktar_kayitlari`
--

DROP TABLE IF EXISTS `esans_is_emirleri_eksik_miktar_kayitlari`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `esans_is_emirleri_eksik_miktar_kayitlari` (
  ...
  `malzeme_turu` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`kayit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `esans_is_emirleri_eksik_miktar_kayitlari`
--

LOCK TABLES `esans_is_emirleri_eksik_miktar_kayitlari` WRITE;
/*!40000 ALTER TABLE `esans_is_emirleri_eksik_miktar_kayitlari` DISABLE KEYS */;
/*!40000 ALTER TABLE `esans_is_emirleri_eksik_miktar_kayitlari` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `esans_is_emri_malzeme_listesi` VALUES (3,37,'Ambalaj Malzemesi 2','malzeme',40.00,'2.00'),(3,24,'Big Bottle','malzeme',60.00,'3.00'),(6,0,'Updated Test Malzeme','Updated Aroma',15.00,'ml'),(7,37,'Ambalaj Malzemesi 2','malzeme',100.00,'2.00'),(7,24,'Big Bottle','malzeme',150.00,'3.00');
...
INSERT INTO `esanslar` VALUES (15,'ES001','Form Test','Form test',210.50,'lt',30.00,'TANK001','Esans Tankı 1'),(16,'ES002','Lavender Essence','Lavender scented natural essence',80.25,'lt',25.50,'TANK001','Esans Tankı 1'),(17,'ES003','Vanilla Essence','Vanilla scented natural essence',75.00,'lt',20.00,'TANK001','Esans Tankı 1'),(18,'ES004','Orange Essence','Orange scented natural essence',90.00,'ml',15.75,'TANK001','Esans Tankı 1'),(19,'ES005','Musk Essence','Musk scented natural essence',120.00,'lt',35.00,'TANK001','Esans Tankı 1'),(20,'ES006','Flower Essence','Flower scented natural essence',85.50,'lt',28.00,'TK001','A1 - Aromatic Tank'),(21,'ES007','Ginger Essence','Ginger scented natural essence',70.00,'lt',22.00,NULL,NULL),(22,'ES008','Mint Essence','Mint scented natural essence',95.75,'ml',18.50,NULL,NULL),(23,'ES009','Jasmine Essence','Jasmine scented natural essence',110.00,'lt',40.00,NULL,NULL),(24,'ES010','Bergamot Essence','Bergamot scented natural essence',118.00,'ml',30.00,'TANK001','Esans Tankı 1'),(25,'ESANS001','Lavanta Esansı','Yüksek kaliteli lavanta esansı',200.00,'lt',30.00,NULL,NULL),(27,'ES015','Test Essence with Tank Updated','Test essence with tank updated',75.00,'ml',20.00,'TANK002','Esans Tankı 2'),(28,'Selam','bu bir esanstır','',10.00,'lt',0.00,'TK001','A1 - Aromatic Tank');
...
INSERT INTO `gider_yonetimi` VALUES (1,'2025-10-10',120.00,'Personel Gideri','Selam',1,'admin','12345','Nakit'),(3,'2025-10-22',123.45,'İşletme Gideri','Otomatik Test Gideri - 1761353164',1,'Admin User','FAT-OTOMATIK-TEST','Kredi Kartı'),(4,'2025-10-04',123.45,'İşletme Gideri','Otomatik Test Gideri - 1761353244',1,'Admin User','FAT-OTOMATIK-TEST','Kredi Kartı'),(5,'2025-10-28',1500.00,'Personel Gideri','Aylýk personel maaþý',1,'Admin','FAT-001','Havale'),(6,'2025-10-28',275.50,'Ýþletme Gideri','Ofis temizlik malzemeleri',1,'Admin','FAT-002','Nakit'),(7,'2025-10-28',450.75,'Enerji','Elektrik faturasý',1,'Admin','FAT-003','Havale'),(8,'2025-10-28',125.30,'Kira','Aylýk kira gideri',1,'Admin','FAT-004','EFT'),(9,'2025-10-28',890.00,'Malzeme Gideri','Üretim malzemeleri alýmý',1,'Admin','FAT-005','Kredi Kartý'),(10,'2025-10-28',320.25,'Taþýt Gideri','Araç yakýt gideri',1,'Admin','FAT-006','Nakit'),(11,'2025-10-28',180.00,'Diðer','Pazarlama materyalleri',1,'Admin','FAT-007','Havale'),(12,'2025-10-28',650.50,'Personel Gideri','Ek mesai ücretleri',1,'Admin','FAT-008','EFT'),(13,'2025-10-28',95.75,'Enerji','Su faturasý',1,'Admin','FAT-009','Nakit'),(14,'2025-10-28',2200.00,'Malzeme Gideri','Yeni üretim cihazý',1,'Admin','FAT-010','Havale'),(15,'2025-10-28',150.00,'İşletme Gideri','Telefon internet gideri',1,'Admin','FAT-011','Nakit'),(16,'2025-10-28',425.80,'Taşıt Gideri','Araç bakým onarým',1,'Admin','FAT-012','Nakit'),(17,'2025-10-28',375.25,'Diðer','Banka iþlem ücreti',1,'Admin','FAT-013','EFT'),(18,'2025-10-28',2100.00,'Personel Gideri','Yýllýk sigorta primleri',1,'Admin','FAT-014','Havale'),(19,'2025-10-28',300.50,'Kira','Depo kirasý',1,'Admin','FAT-015','EFT'),(20,'2025-10-28',750.00,'Malzeme Gideri','Paketleme malzemeleri',1,'Admin','FAT-016','Nakit'),(21,'2025-10-28',125.00,'Enerji','Doðalgaz faturasý',1,'Admin','FAT-017','Havale'),(22,'2025-10-28',1800.75,'Personel Gideri','Araç sigorta primi',1,'Admin','FAT-018','Kredi Kartı'),(25,'2025-08-15',3844.06,'Enerji','Sigorta primi',1,NULL,'7676','Kredi Kartı'),(26,'2025-08-04',2734.66,'İşletme Gideri','Sigorta primi',1,NULL,'6139','Diğer'),(27,'2025-06-19',2600.92,'Taşıt Gideri','Sigorta primi',1,NULL,'4373','Havale'),(28,'2025-07-09',361.21,'İşletme Gideri','Bakım onarım gideri',1,NULL,'1561','Diğer'),(29,'2025-09-27',3649.60,'İşletme Gideri','Kira ödemesi',1,NULL,'2592','Nakit'),(30,'2025-05-01',4843.45,'Enerji','Kira gideri',1,NULL,'1448','Diğer'),(31,'2025-08-16',3898.43,'Diğer','Personel maaşı',1,NULL,'4567','Kredi Kartı'),(32,'2025-10-19',171.27,'Diğer','Temizlik malzemeleri',1,NULL,'1259','Havale'),(33,'2025-10-01',4856.55,'Kira','Personel eğitim gideri',1,NULL,'6143','Diğer'),(34,'2025-04-15',444.79,'Enerji','Kira ödemesi',1,NULL,'4911','Kredi Kartı'),(35,'2025-07-19',4338.84,'Kira','Yazılım lisans ücreti',1,NULL,'2887','Nakit'),(36,'2025-06-10',3301.95,'Diğer','Temizlik malzemeleri',1,NULL,'3577','Diğer'),(37,'2025-06-05',3767.71,'Enerji','Pazarlama harcaması',1,NULL,'7013','Diğer'),(38,'2025-06-05',771.37,'Diğer','Kira ödemesi',1,NULL,'2340','Havale'),(39,'2025-12-13',2507.73,'Diğer','Ofis malzeme alışverişi',1,NULL,'2750','Nakit'),(40,'2025-09-17',127.72,'İşletme Gideri','Telefon faturası',1,NULL,'1873','Kredi Kartı'),(41,'2025-04-12',767.18,'Kira','Telefon faturası',1,NULL,'2275','Kredi Kartı'),(42,'2025-09-20',1264.02,'İşletme Gideri','Pazarlama harcaması',1,NULL,'6812','Nakit'),(43,'2025-09-05',770.47,'Malzeme Gideri','Temizlik malzemeleri',1,NULL,'3448','Diğer'),(44,'2025-06-25',1385.73,'Enerji','Telefon faturası',1,NULL,'5278','Havale'),(45,'2025-11-12',3041.26,'İşletme Gideri','Temizlik malzemeleri',1,NULL,'1200','Havale'),(46,'2025-10-23',2682.20,'Kira','Temizlik malzemeleri',1,NULL,'7596','Nakit'),(47,'2025-11-02',2314.53,'Personel Gideri','Kira gideri',1,NULL,'6375','Kredi Kartı'),(48,'2025-08-03',1242.80,'Taşıt Gideri','Kira gideri',1,NULL,'6104','Nakit'),(49,'2025-02-05',1854.91,'İşletme Gideri','Taşıt yakıt gideri',1,NULL,'6960','Havale'),(50,'2025-04-05',1658.30,'Diğer','Telefon faturası',1,NULL,'1011','Nakit'),(51,'2025-04-09',2405.36,'Personel Gideri','Sigorta primi',1,NULL,'1696','Nakit'),(52,'2025-12-12',2418.61,'Kira','Telefon faturası',1,NULL,'4421','Nakit'),(53,'2025-04-20',797.23,'Taşıt Gideri','Taşıt bakım gideri',1,NULL,'8019','Kredi Kartı'),(54,'2025-12-12',2481.00,'İşletme Gideri','Personel maaşı',1,NULL,'2808','Diğer'),(55,'2025-10-19',2981.97,'Enerji','İnternet hizmeti',1,NULL,'9120','Nakit'),(56,'2025-03-17',4525.53,'Personel Gideri','Kira ödemesi',1,NULL,'9082','Kredi Kartı'),(57,'2025-06-08',4131.23,'İşletme Gideri','Kira ödemesi',1,NULL,'9727','Nakit'),(58,'2025-10-26',4480.57,'Malzeme Gideri','Taşıt yakıt gideri',1,NULL,'8239','Nakit'),(59,'2025-08-02',4544.26,'Enerji','Personel maaşı',1,NULL,'5834','Havale'),(60,'2025-01-13',2888.69,'Taşıt Gideri','İnternet hizmeti',1,NULL,'7395','Nakit'),(61,'2025-06-27',4511.12,'Enerji','Personel maaşı',1,NULL,'4097','Diğer'),(62,'2025-08-03',254.36,'Personel Gideri','Taşıt yakıt gideri',1,NULL,'1693','Kredi Kartı'),(63,'2025-12-09',4654.02,'Taşıt Gideri','Sigorta primi',1,NULL,'8507','Nakit'),(64,'2025-08-10',1536.44,'Personel Gideri','Telefon faturası',1,NULL,'7274','Nakit'),(65,'2025-03-12',4601.08,'Malzeme Gideri','Pazarlama harcaması',1,NULL,'3246','Kredi Kartı'),(66,'2025-06-09',2972.49,'Diğer','Sigorta primi',1,NULL,'8207','Nakit'),(67,'2025-12-15',3940.27,'Personel Gideri','Telefon faturası',1,NULL,'1123','Nakit'),(68,'2025-10-01',2414.88,'Taşıt Gideri','Kira gideri',1,NULL,'6984','Havale'),(69,'2025-04-08',4659.13,'Kira','Telefon faturası',1,NULL,'8643','Nakit'),(70,'2025-10-08',3261.63,'Malzeme Gideri','Bakım onarım gideri',1,NULL,'3983','Nakit'),(71,'2025-10-17',4651.39,'Kira','Kira gideri',1,NULL,'8151','Diğer'),(72,'2025-06-19',2842.25,'Kira','Sigorta primi',1,NULL,'2557','Nakit'),(73,'2025-08-06',4631.67,'Taşıt Gideri','Personel eğitim gideri',1,NULL,'3745','Diğer'),(74,'2025-09-28',4815.05,'Enerji','İnternet hizmeti',1,NULL,'3721','Havale'),(75,'2025-04-24',2874.71,'Malzeme Gideri','Pazarlama harcaması',1,NULL,'3559','Havale'),(76,'2025-07-08',1734.84,'Taşıt Gideri','Sigorta primi',1,NULL,'8610','Nakit'),(77,'2025-05-08',2344.18,'İşletme Gideri','Bakım onarım gideri',1,NULL,'1536','Kredi Kartı'),(78,'2025-03-20',2961.01,'Taşıt Gideri','Taşıt yakıt gideri',1,NULL,'7522','Nakit'),(79,'2025-11-02',2591.05,'Personel Gideri','Bakım onarım gideri',1,NULL,'6387','Havale'),(80,'2025-01-25',4620.80,'Taşıt Gideri','Sigorta primi',1,NULL,'5629','Havale'),(81,'2025-02-03',106.17,'Kira','Ofis malzeme alışverişi',1,NULL,'9473','Kredi Kartı'),(82,'2025-01-09',2954.49,'Personel Gideri','Bakım onarım gideri',1,NULL,'5538','Diğer'),(83,'2025-03-21',3602.70,'İşletme Gideri','Kira ödemesi',1,NULL,'9157','Diğer'),(84,'2025-04-12',1653.04,'Taşıt Gideri','Taşıt yakıt gideri',1,NULL,'7664','Nakit'),(85,'2025-11-15',4022.12,'Enerji','Bakım onarım gideri',1,NULL,'1901','Diğer'),(86,'2025-05-09',1749.87,'Malzeme Gideri','Pazarlama harcaması',1,NULL,'2560','Havale'),(87,'2025-04-24',2970.21,'Taşıt Gideri','Kira ödemesi',1,NULL,'6410','Diğer'),(88,'2025-12-10',4841.62,'Taşıt Gideri','Personel maaşı',1,NULL,'4367','Diğer'),(89,'2025-11-21',3376.28,'İşletme Gideri','Kira ödemesi',1,NULL,'9216','Kredi Kartı'),(90,'2025-09-10',2532.63,'Taşıt Gideri','Kira ödemesi',1,NULL,'9429','Diğer'),(91,'2025-11-25',4762.83,'Taşıt Gideri','Kira gideri',1,NULL,'1893','Havale'),(92,'2025-11-20',4870.09,'Personel Gideri','İnternet hizmeti',1,NULL,'8888','Diğer'),(93,'2025-07-16',2089.96,'Kira','Sigorta primi',1,NULL,'1878','Havale'),(94,'2025-05-03',2078.93,'Enerji','Kira ödemesi',1,NULL,'3778','Havale'),(95,'2025-09-14',1225.93,'Malzeme Gideri','Taşıt yakıt gideri',1,NULL,'8174','Kredi Kartı'),(96,'2025-09-06',4344.01,'Enerji','Yazılım lisans ücreti',1,NULL,'2070','Nakit'),(97,'2025-02-21',2570.50,'Malzeme Gideri','Temizlik malzemeleri',1,NULL,'6574','Nakit'),(98,'2025-09-26',3125.72,'Taşıt Gideri','Personel eğitim gideri',1,NULL,'1753','Diğer'),(99,'2025-03-21',1245.81,'Personel Gideri','Temizlik malzemeleri',1,NULL,'7607','Diğer'),(100,'2025-08-25',2743.24,'Enerji','Taşıt bakım gideri',1,NULL,'1764','Diğer'),(101,'2025-06-11',4250.97,'Personel Gideri','İnternet hizmeti',1,NULL,'7587','Diğer'),(102,'2025-08-18',1785.99,'Kira','Personel maaşı',1,NULL,'9642','Nakit'),(103,'2025-08-03',3750.95,'Diğer','Yazılım lisans ücreti',1,NULL,'6511','Havale'),(104,'2025-01-19',823.07,'İşletme Gideri','Taşıt bakım gideri',1,NULL,'1039','Nakit'),(105,'2025-06-17',4847.76,'İşletme Gideri','Ofis malzeme alışverişi',1,NULL,'8810','Kredi Kartı'),(106,'2025-05-12',4514.41,'İşletme Gideri','Taşıt bakım gideri',1,NULL,'5912','Diğer'),(107,'2025-07-04',621.92,'Kira','Personel maaşı',1,NULL,'2116','Havale'),(108,'2025-09-23',1450.84,'Diğer','Bakım onarım gideri',1,NULL,'6378','Kredi Kartı'),(109,'2025-02-01',770.37,'Kira','Kira gideri',1,NULL,'2897','Diğer'),(110,'2025-11-09',2160.28,'Enerji','Yazılım lisans ücreti',1,NULL,'7438','Nakit'),(111,'2025-06-17',1269.53,'Personel Gideri','Kira ödemesi',1,NULL,'9402','Diğer'),(112,'2025-11-18',3276.78,'Diğer','Personel eğitim gideri',1,NULL,'4450','Havale'),(113,'2025-08-18',3485.25,'Taşıt Gideri','Sigorta primi',1,NULL,'5137','Nakit'),(114,'2025-06-12',1274.74,'İşletme Gideri','Bakım onarım gideri',1,NULL,'6263','Kredi Kartı'),(115,'2025-03-13',3128.33,'Enerji','İnternet hizmeti',1,NULL,'1994','Havale'),(116,'2025-12-12',4686.55,'Taşıt Gideri','Temizlik malzemeleri',1,NULL,'3937','Havale'),(117,'2025-10-26',4119.51,'İşletme Gideri','Personel maaşı',1,NULL,'2715','Havale'),(118,'2025-04-28',1086.65,'Kira','Personel eğitim gideri',1,NULL,'2864','Kredi Kartı'),(119,'2025-03-09',2640.87,'Enerji','Sigorta primi',1,NULL,'6436','Kredi Kartı'),(120,'2025-03-19',4969.64,'Kira','Ofis malzeme alışverişi',1,NULL,'1253','Nakit'),(121,'2025-10-24',4981.53,'Enerji','Taşıt yakıt gideri',1,NULL,'3484','Havale'),(122,'2025-12-15',3067.64,'Diğer','Taşıt bakım gideri',1,NULL,'7047','Diğer'),(123,'2025-02-13',1828.86,'Taşıt Gideri','Yazılım lisans ücreti',1,NULL,'8389','Diğer'),(124,'2025-07-20',2578.10,'Personel Gideri','Temizlik malzemeleri',1,NULL,'3753','Havale');
/*!40000 ALTER TABLE `gider_yonetimi` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `giris_kalite_kontrolu`
--

DROP TABLE IF EXISTS `giris_kalite_kontrolu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `giris_kalite_kontrolu` (
  ...
  `kontrol_eden_personel_id` int(11) DEFAULT NULL,
  `kontrol_eden_personel_adi` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `giris_kalite_kontrolu`
--

LOCK TABLES `giris_kalite_kontrolu` WRITE;
/*!40000 ALTER TABLE `giris_kalite_kontrolu` DISABLE KEYS */;
/*!40000 ALTER TABLE `giris_kalite_kontrolu` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `malzemeler` (
  ...
  `malzeme_ismi` varchar(255) NOT NULL,
  `malzeme_turu` varchar(100) NOT NULL,
  `malzeme_foto_ismi` varchar(255) DEFAULT NULL,
  `not_bilgisi` text DEFAULT NULL,
  `stok_miktari` decimal(10,2) DEFAULT 0.00,
  `birim` varchar(50) DEFAULT 'adet',
...
INSERT INTO `malzemeler` VALUES (22,'Perfume 2','diger',NULL,NULL,482.00,'adet',27.47,'TRY',0,0,'Ana Depo','R001',25),(23,'Perfume 3','diger',NULL,NULL,484.00,'adet',140.13,'TRY',0,0,'Ana Depo','R001',32),(24,'Perfume 4','diger',NULL,NULL,307.00,'adet',146.51,'TRY',0,0,'Ana Depo','R001',26),(25,'Perfume 5','diger',NULL,NULL,379.00,'adet',69.39,'TRY',0,0,'Ana Depo','R001',17),(26,'Perfume 6','diger',NULL,NULL,55.00,'adet',61.35,'TRY',0,0,'Ana Depo','R001',32),(27,'Perfume 7','diger',NULL,NULL,145.00,'adet',69.17,'TRY',0,0,'Ana Depo','R001',33),(28,'Perfume 8','diger',NULL,NULL,163.00,'adet',125.87,'TRY',0,0,'Ana Depo','R001',38),(30,'10 evo','diger',NULL,NULL,500.00,'adet',66.07,'TRY',0,0,'Ana Depo','R001',38),(31,'Medium Box','diger',NULL,NULL,0.00,'adet',0.00,'TRY',0,0,'Ana Depo','R001',0),(37,'Ambalaj Malzemesi 2','etiket','am2.jpg','Etiket',10.00,'gr',20.00,'USD',0,1,'Ana Depo','R001',100);
...
INSERT INTO `montaj_is_emirleri` VALUES (1,'2025-10-24','Sistem','21','Test Product',10.00,'adet','2025-10-24','2025-10-24','Test work order Test completion','tamamlandi',10.00,0.00,11,'2025-10-24','2025-10-24'),(2,'2025-10-24','Sistem','22','Test Product 2',5.00,'adet','2025-10-24','2025-10-24','Test work order for revert Test completion','tamamlandi',5.00,0.00,12,'2025-10-24','2025-10-24'),(3,'2025-10-24','Sistem','23','Test Product 3',8.00,'adet','2025-10-24','2025-10-24','Test work order for revert completion Test completion for revert','uretimde',0.00,0.00,13,'2025-10-24',NULL),(5,'2025-10-24','Admin User','23','Test Product 3',3.00,'adet','2025-10-24','2025-10-24','New test work order New test work order','tamamlandi',1.00,0.00,13,'2025-10-24','2025-11-16'),(6,'2025-10-24','Admin User','22','Perfume 2',5.00,'adet','2025-10-24','2025-10-24','Transaction test work order Test completion for transaction','uretimde',0.00,0.00,12,'2025-10-24',NULL);
/*!40000 ALTER TABLE `montaj_is_emirleri` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `montaj_is_emirleri_eksik_miktar_kayitlari`
--

DROP TABLE IF EXISTS `montaj_is_emirleri_eksik_miktar_kayitlari`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `montaj_is_emirleri_eksik_miktar_kayitlari` (
  `is_emri_numarasi` int(11) NOT NULL,
  `eksik_miktar` decimal(10,2) NOT NULL,
  `eksik_kalma_nedeni` varchar(50) NOT NULL,
  `malzeme_kodu` int(11) NOT NULL,
...
--
-- Dumping data for table `montaj_is_emirleri_eksik_miktar_kayitlari`
--

LOCK TABLES `montaj_is_emirleri_eksik_miktar_kayitlari` WRITE;
/*!40000 ALTER TABLE `montaj_is_emirleri_eksik_miktar_kayitlari` DISABLE KEYS */;
/*!40000 ALTER TABLE `montaj_is_emirleri_eksik_miktar_kayitlari` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `montaj_is_emri_malzeme_listesi` VALUES (2,'ES002','Lavender Essence','esans',225.00,'45.00'),(2,'26','White Label','etiket',10.00,'2.00'),(2,'27','Plastic Cap','kapak',5.00,'1.00'),(5,'ES003','Vanilla Essence','esans',30.00,'10.00'),(5,'25','Standard Pump','pompa',3.00,'1.00');
/*!40000 ALTER TABLE `montaj_is_emri_malzeme_listesi` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `musteri_davranis_logu`
--

DROP TABLE IF EXISTS `musteri_davranis_logu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `musteri_davranis_logu` (
  ...
  `siparis_olusturdu_mu` tinyint(1) DEFAULT 0,
  `oturum_suresi_dakika` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `musteri_davranis_logu`
--

LOCK TABLES `musteri_davranis_logu` WRITE;
/*!40000 ALTER TABLE `musteri_davranis_logu` DISABLE KEYS */;
/*!40000 ALTER TABLE `musteri_davranis_logu` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `siparis_kalemleri` VALUES (33,31,'Parfüm A',1,'adet',150.00,150.00),(33,32,'Parfüm B',10,'adet',180.00,1800.00),(34,31,'Parfüm Ananas',10,'0',150.00,1500.00),(34,32,'Parfüm B',1,'adet',180.00,180.00),(34,28,'Perfume 8',77,'adet',150.00,11550.00),(33,24,'Perfume 4',768,'adet',150.00,115200.00),(35,22,'Perfume 2',1,'adet',150.00,150.00),(35,23,'Perfume 3',3,'adet',150.00,450.00),(35,26,'Perfume 6',22,'adet',150.00,3300.00);
...
INSERT INTO `siparisler` VALUES (26,4,'Ahmet Yilmaz','2025-10-14 03:27:46','iptal_edildi',2,'Ahmet Yilmaz',NULL,NULL,NULL,''),(27,1,'Müşteri A','2025-10-14 03:12:22','iptal_edildi',4,'Müşteri A',NULL,NULL,NULL,''),(28,4,'Ahmet Yilmaz','2025-10-14 03:27:43','iptal_edildi',2,'Ahmet Yilmaz',NULL,NULL,NULL,''),(29,3,'Test Customer','2025-10-14 03:31:25','iptal_edildi',5,'Test Customer',NULL,NULL,NULL,'Test siparişi - manual test'),(30,3,'Test Customer','2025-10-14 03:35:14','iptal_edildi',5,'Test Customer',NULL,NULL,NULL,'Test siparişi - manual test'),(31,3,'Test Customer','2025-10-14 03:35:53','iptal_edildi',5,'Test Customer',NULL,NULL,NULL,'Test siparişi - manual test'),(32,4,'Ahmet Yilmaz','2025-10-14 03:36:35','iptal_edildi',2,'Ahmet Yilmaz',NULL,NULL,NULL,''),(33,4,'Ahmet Yilmaz','2025-10-14 03:37:33','tamamlandi',779,'Ahmet Yilmaz',1,'Admin User','2025-10-14 15:59:24',''),(34,1,'Müşteri A','2025-10-14 03:55:03','onaylandi',88,'Müşteri A',1,'Admin User','2025-11-01 04:28:52',''),(35,8,'Ali Can','2025-10-29 17:05:10','tamamlandi',26,'Ali Can',1,'Admin User','2025-11-01 04:17:00','');
...
INSERT INTO `stok_hareket_kayitlari` VALUES (305,'2025-11-16 03:40:43','Ürün','23','Test Product 3','adet',1.00,'Giriş','Üretimden Giriş',NULL,NULL,NULL,NULL,5,NULL,NULL,'İş emri tamamlama',1,'Admin User',NULL,NULL);
...
INSERT INTO `urun_agaci` VALUES (13,22,'Perfume 2','esans','ES002','Lavender Essence',45.00,'urun'),(14,22,'Perfume 2','etiket','26','White Label',2.00,'urun'),(15,22,'Perfume 2','kapak','27','Plastic Cap',1.00,'urun'),(23,24,'Bergamot Essence','malzeme','37','Ambalaj Malzemesi 2',2.00,'esans'),(24,24,'Bergamot Essence','malzeme','31','Medium Box',3.00,'esans'),(25,30,'10 evo','esans','ES010','Bergamot Essence',10.00,'urun'),(26,30,'10 evo','etiket','37','Ambalaj Malzemesi 2',2.00,'urun');
...
--
-- Table structure for table `yetki_tablolari`
--

DROP TABLE IF EXISTS `yetki_tablolari`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yetki_tablolari` (
  `yetki_id` int(11) NOT NULL AUTO_INCREMENT,
  `personel_id` int(11) NOT NULL,
  `erisim_sayfasi` varchar(255) NOT NULL,
  `olusturma_tarihi` datetime DEFAULT current_timestamp(),
  `olusturan_personel_id` int(11) NOT NULL,
  PRIMARY KEY (`yetki_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `yetki_tablolari`
--

LOCK TABLES `yetki_tablolari` WRITE;
/*!40000 ALTER TABLE `yetki_tablolari` DISABLE KEYS */;
/*!40000 ALTER TABLE `yetki_tablolari` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_esans_maliyetleri` AS select `ua`.`urun_kodu` AS `esans_kodu`,sum(`ua`.`bilesen_miktari` * case `m`.`para_birimi` when 'USD' then `m`.`alis_fiyati` * (select `ayarlar`.`ayar_deger` from `ayarlar` where `ayarlar`.`ayar_anahtar` = 'dolar_kuru') when 'EUR' then `m`.`alis_fiyati` * (select `ayarlar`.`ayar_deger` from `ayarlar` where `ayarlar`.`ayar_anahtar` = 'euro_kuru') else `m`.`alis_fiyati` end) AS `toplam_maliyet` from (`urun_agaci` `ua` join `malzemeler` `m` on(`ua`.`bilesen_kodu` = `m`.`malzeme_kodu`)) where `ua`.`urun_kodu` in (select `esanslar`.`esans_kodu` from `esanslar`) group by `ua`.`urun_kodu` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_urun_maliyetleri` AS select `ua`.`urun_kodu` AS `urun_kodu`,sum(`ua`.`bilesen_miktari` * case `m`.`para_birimi` when 'USD' then `m`.`alis_fiyati` * (select `ayarlar`.`ayar_deger` from `ayarlar` where `ayarlar`.`ayar_anahtar` = 'dolar_kuru') when 'EUR' then `m`.`alis_fiyati` * (select `ayarlar`.`ayar_deger` from `ayarlar` where `ayarlar`.`ayar_anahtar` = 'euro_kuru') else `m`.`alis_fiyati` end) AS `teorik_maliyet` from (`urun_agaci` `ua` join `malzemeler` `m` on(`ua`.`bilesen_kodu` = `m`.`malzeme_kodu`)) group by `ua`.`urun_kodu` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-11-18 21:59:08
