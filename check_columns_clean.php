...
echo implode(", ", getTableColumns('montaj_is_emirleri'));

echo "\n\nColumns in montaj_is_emri_malzeme_listesi:\n";
echo implode(", ", getTableColumns('montaj_is_emri_malzeme_listesi'));

echo "\n\nColumns in montaj_is_emirleri_eksik_miktar_kayitlari:\n";
echo implode(", ", getTableColumns('montaj_is_emirleri_eksik_miktar_kayitlari'));
?>
