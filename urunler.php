            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="search-container">
                    <div class="input-group" style="width: 300px;">
                        ...
                        <input type="text" class="form-control" v-model="search" @input="loadProducts(1)" placeholder="Urun ara...">
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mt-3">
                    <div class="records-per-page mb-2 mb-md-0">
                        ...
                        <select v-model="limit" @change="loadProducts(1)" class="form-control d-inline-block" style="width: auto; margin-left: 8px;">
                        ...
                        <nav>
                            <ul class="pagination mb-0">
                                <li class="page-item" :class="{ disabled: currentPage === 1 }">
                                    <a class="page-link" href="#" @click.prevent="loadProducts(currentPage - 1)"><i class="fas fa-chevron-left"></i> Önceki</a>
                                </li>
                                ...
                                <li v-if="currentPage < totalPages - 2" class_="page-item">
                                    <a class="page-link" href="#" @click.prevent="loadProducts(totalPages)">{{ totalPages }}</a>
                                </li>
                                <li class="page-item" :class="{ disabled: currentPage === totalPages }">
                                    <a class="page-link" href="#" @click.prevent="loadProducts(currentPage + 1)">Sonraki <i class="fas fa-chevron-right"></i></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" v-model="modal.data.satis_fiyati" min="0">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
