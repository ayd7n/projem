...
if (isset($_GET['action'])) {
    ...
    if ($action == 'add_employee') {
        ...
        $bordrolu_calisan_mi = isset($_POST['bordrolu_calisan_mi']) && $_POST['bordrolu_calisan_mi'] == '1' ? 1 : 0;
        $aylik_brut_ucret = $connection->real_escape_string($_POST['aylik_brut_ucret'] ?? 0);
        $sifre = $_POST['sifre'] ?? '';
        ...
        if (empty($ad_soyad)) {
            ...
            try {
                ...
                $query = "INSERT INTO personeller (ad_soyad, tc_kimlik_no, dogum_tarihi, ise_giris_tarihi, pozisyon, departman, e_posta, telefon, telefon_2, adres, notlar, sistem_sifresi, bordrolu_calisan_mi, aylik_brut_ucret) VALUES ('$ad_soyad', '$tc_kimlik_no', '$dogum_tarihi', '$ise_giris_tarihi', '$pozisyon', '$departman', '$e_posta', '$telefon', '$telefon_2', '$adres', '$notlar', '$escaped_hashed_password', $bordrolu_calisan_mi, '$aylik_brut_ucret')";
