            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="stat-info">
                            <h3 style="font-size: 1.5rem; margin: 0;">{{ totalCustomers }}</h3>
                            <p style="color: var(--text-secondary); margin: 0; font-size: 0.9rem;">Toplam Müşteri</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <nav>
                            <ul class="pagination mb-0">
                                <li class="page-item" :class="{ disabled: currentPage === 1 }">
                                    <a class="page-link" href="#" @click.prevent="loadCustomers(currentPage - 1)"><i class="fas fa-chevron-left"></i> Önceki</a>
                                </li>
                                ...
                                <li class="page-item" :class="{ disabled: currentPage === totalPages }">
                                    <a class="page-link" href="#" @click.prevent="loadCustomers(currentPage + 1)">Sonraki <i class="fas fa-chevron-right"></i></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
