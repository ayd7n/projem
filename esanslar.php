        ...
        <div class="main-content">
            ...
            <div class="row">
                <div class="col-md-8">
                    <?php if (yetkisi_var('action:esanslar:create')): ?>
                        <button @click="acYeniEsansModal" class="btn btn-primary mb-3"><i class="fas fa-plus"></i> Yeni
                            Esans Ekle</button>
                    <?php endif; ?>
                </div>
                <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <h2 class="mb-3 mb-md-0 mr-md-3 text-nowrap"><i class="fas fa-list"></i> Esans Listesi</h2>
