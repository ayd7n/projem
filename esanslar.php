...
<body>
    <div id="app">
            ...
            <div class="card">
                <div class="card-header d-flex flex-column flex-md-row justify-content-start align-items-center py-2 px-3">
                    <div class="d-flex align-items-center flex-wrap" style="gap: 6px;">
                        <!-- Yeni Esans Ekle Butonu -->
                        <?php if (yetkisi_var('action:esanslar:create')): ?>
                            <button @click="acYeniEsansModal" class="btn btn-primary btn-sm" style="font-size: 0.75rem; padding: 4px 10px;"><i class="fas fa-plus"></i> Yeni Esans</button>
                        <?php endif; ?>
                        <!-- Arama Kutusu -->
                        <div class="input-group input-group-sm" style="width: auto; min-width: 180px;">
                            ...
                            <input type="text" class="form-control form-control-sm" v-model="search" @input="performSearch"
                                placeholder="Esans ara..." style="font-size: 0.75rem; padding: 4px 8px;">
                        </div>
                        <!-- Stat Kartı -->
                        <div class="stat-card-mini"
                            ...
                            <span style="font-weight: 600;">{{ toplamEsans }}</span>
                            <span class="ml-1" style="opacity: 0.9;">Esans</span>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr v-else-if="esansListesi.length === 0">
                                    <td colspan="9" class="text-center p-4">
                                        ...
                                        <p class="mt-2 mb-0">Aramanızla eşleşen esans bulunamadı.</p>
                                    </td>
                                </tr>
                                <tr v-for="esans in esansListesi" :key="esans.esans_id">
                                    <td class="actions">
                                        <?php if (yetkisi_var('action:esanslar:edit')): ?>
                                            <button @click="acDuzenleModal(esans)" class="btn btn-primary btn-sm"><i
                                                    class="fas fa-edit"></i></button>
                                        <?php endif; ?>
                                        <?php if (yetkisi_var('action:esanslar:delete')): ?>
                                            <button @click="silEsans(esans.esans_id)" class="btn btn-danger btn-sm"><i
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mt-3">
                        <div class="records-per-page mb-2 mb-md-0 w-100 w-md-auto">
                            ...
                            <select v-model="limit" class="form-control d-inline-block"
                                style="width: auto; margin-left: 8px;" @change="esanslariYukle(1)">
                                ...
                                <ul class="pagination justify-content-center justify-content-md-end mb-0">
                                    ...
                                    <li class="page-item" :class="{ disabled: currentPage <= 1 }">
                                        <a class="page-link" href="#"
                                            @click.prevent="esanslariYukle(Math.max(1, currentPage - 1))">
                                    ...
                                    <li v-for="page in pageNumbers" :key="page" class="page-item"
                                        ...
                                        <a class="page-link" href="#" @click.prevent="esanslariYukle(page)">{{ page
                                            }}</a>
                                    </li>
                                    ...
                                    <li v-if="currentPage < totalPages - 2" class="page-item">
                                        <a class="page-link" href="#" @click.prevent="esanslariYukle(totalPages)">{{
                                            totalPages }}</a>
                                    </li>
                                    ...
                                    <li class="page-item" :class="{ disabled: currentPage >= totalPages }">
                                        <a class="page-link" href="#"
                                            @click.prevent="esanslariYukle(Math.min(totalPages, currentPage + 1))">
        ...
        <!-- Essence Modal -->
        <div class="modal fade" :class="{show: modalAcik}" v-if="modalAcik"
            style="display: block; background-color: rgba(0,0,0,0.5);" @click="kapatModal">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="esans_kodu"
                                            v-model="seciliEsans.esans_kodu" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="esans_ismi">Esans İsmi *</label>
                                        <input type="text" class="form-control" id="esans_ismi"
                                            v-model="seciliEsans.esans_ismi" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control" id="tank_kodu" v-model="seciliEsans.tank_kodu"
                                            @change="tankSecildi">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tank_ismi"
                                            v-model="seciliEsans.tank_ismi" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="stok_miktari"
                                            v-model="seciliEsans.stok_miktari" min="0">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control" id="demlenme_suresi_gun"
                                            v-model="seciliEsans.demlenme_suresi_gun" min="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <label for="not_bilgisi">Not Bilgisi</label>
                                <textarea class="form-control" id="not_bilgisi" v-model="seciliEsans.not_bilgisi"
                                    rows="3"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" @click="kapatModal"><i
                                    class="fas fa-times"></i> İptal</button>
                            <button type="submit" class="btn btn-primary"
                                :class="{'btn-success': seciliEsans.esans_id}"><i class="fas fa-save"></i> {{
                                submitButonMetni }}</button>
                        </div>
                    </form>
                </div>
            </div>
