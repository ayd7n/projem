                            ...
                            <?php if (!empty($report_data)): ?>
                                <?php foreach ($report_data as $row): ?>
                                    <tr>
                                        ...
                                        <td><span
                                                class="badge badge-info"><?php echo number_format($row['yapilacak_odeme_miktari'], 2, ',', '.'); ?>
                                                Adet</span></td>
                                        <td><strong><span
                                                    class="badge badge-success"><?php echo format_currency($row['yapilacak_odeme_tutari'], $row['para_birimi']); ?></span></strong>
                                        </td>
                                        <td>
                                            <?php
                                            $curr = $row['para_birimi'];
                                            if ($curr === 'TL')
                                                echo '<span class="badge badge-primary">₺ TRY</span>';
                                            elseif ($curr === 'USD')
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="4" class="text-center p-4">
                                        ...
                                        <h4>Tebrikler!</h4>
                                        <p class="text-muted">Tedarikçilere yapılacak bekleyen bir ödeme bulunmamaktadır.
                                        </p>
                                    </td>
                                </tr>
                            <?php endif; ?>
