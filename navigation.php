            ...
            <div class="module-grid-container">
                ...
                <div class="module-category" id="operations">
                    ...
                    <div class="module-grid">
                        ...
                        <?php if (yetkisi_var('page:view:montaj_onay_ekrani')): ?>
                            <a href="montaj_onay_ekrani.php" class="module-card">
                                <div class="icon"><i class="fas fa-clipboard-check"></i></div>
                                <div class="card-content">
                                    <span class="title">Montaj Onay Ekrani</span>
                                    <p class="description">Onay bekleyen montaj is emirlerini onaylayin veya reddedin.</p>
                                </div>
                            </a>
                        <?php endif; ?>
