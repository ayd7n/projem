...
$sql_queries = [
    ...
    SELECT 
        ...
        COALESCE(um.birim_maliyet, 0) AS birim_maliyet,
        COALESCE(um.fiili_maliyet, 0) AS fiili_maliyet,
        CASE 
            WHEN COALESCE(um.fiili_maliyet, 0) > 0 
            THEN (u.satis_fiyati / um.fiili_maliyet) * 100 
            ELSE 0 
        END AS kar_orani,
